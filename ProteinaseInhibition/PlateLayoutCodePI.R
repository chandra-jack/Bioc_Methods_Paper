...
# Making plate templates for Proteinase Inhibition
...
setwd("~/Documents/Friesen\ lab/Enzymes\ copy/Methods_Paper/ProteinaseInhibition")

platemap1 <- read.csv("PI_PlateMap_12_1_2016.csv")
